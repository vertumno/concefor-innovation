...
│   ├── even3/                (plataforma de inscrição: crachá, QR, cadastro + api.md da integração)
│   └── benchmark-app-eden/   (prints do app do evento EDEN — referência de UI da barra inferior)
