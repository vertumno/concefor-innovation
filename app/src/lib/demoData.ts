...
const PROGRAMA: Raw[] = [
  ...
  { id: "palestra-mariano", d: 19, ini: "14:30", fim: "16:00", titulo: "Autoria com IA generativa: desafios para a EaD", descricao: "Palestra sobre autoria e IA generativa na educação a distância.", sala: "Auditório", eixo: "Palestra", palestrante: "Prof. Dr. Mariano Pimentel", speakerIds: ["mariano-pimentel"] },
