...
## Canais (preencher handles/links)
| Canal | Perfil / link | Uso principal |
|---|---|---|
| Site oficial | https://concefor.cefor.ifes.edu.br/ | Fonte oficial, programação, inscrições |
| Instagram | `___` | Cards, reels, stories (canal principal de divulgação) |
| YouTube | `___` | Transmissão ao vivo + gravações |
...
- Prazo mínimo entre entrega e publicação: `___`

## Regras de nomeação de arquivos
`AAAA-MM-DD_fase_tipo_descricao_versao`
Ex.: `2026-08-07_pre_card_regressiva-10dias_v2.png`
