# Contexto · Programação (dia a dia)
...
>
> 📍 **LOCAL — definido em 28/07:** **todas as palestras e mesas-redondas acontecem no PÁTIO.**
> Isso fecha **6 atividades** (4 palestras + 2 mesas). O restante — credenciamento, sessões
> técnicas, mostras, momentos culturais, coffees, almoço e premiação — **ainda está sem local**
> e foi pedido à Viviane (Coordenação Geral) em 28/07.
> Os **banners de programação por dia** (#3 a #6 dos 10 do TR) imprimem **data · horário · local**,
> então dependem dessas respostas. Ver [`banners/brief.md`](../producao/01-brindes-promocionais/banners/brief.md).
...
2. E-book do NTE: *"Chegando agora no NTE? Núcleo de Tecnologias Educacionais: práticas, processos e orientações"*
3. Nova plataforma de cursos MOOCs
4. Nova versão da Base de Conhecimento do Cefor

## Terça-feira · 18/08/2026
| Hora | Atividade | Local |
|---|---|---|
| 8h00 | Mostra de Produtos e Produções Técnicas · Painel | 🔴 falta |
| 9h30 | Mesa-Redonda *"Tecnologia Delas"* · Dra. Márcia Oliveira, Dra. Jaqueline Sanz, Dra. Mariella Berger | ✅ **Pátio** |
...
## O que mudou na atualização de 21/07

1. **Bloco de Lançamentos entrou** na segunda (20h às 20h30) e a Celebração dos 20 anos passou
   de 20h para 20h30.
2. **Palestra nova na quarta, às 16h30:** *"Inovações da IA para a Educação"*, com o
   **Dr. Mauro Oliveira**. Palestrante que ainda não estava em nenhum material nosso.
3. **Mesa "Desafios da EaD" fechou a composição:** Felipe Maciel Tessarolo e Dra. Rutinelli da
   Penha Fávero. O site não cita mais "convidados locais", então a pendência de confirmação
   que arrastávamos desde 16/07 está resolvida.

## Destaques para comunicação
- **Abertura + lançamentos + bolo dos 20 anos** (17/08, noite): a noite mais densa do evento,
  garantir cobertura e reel. São 4 lançamentos seguidos da celebração.
- **4 palestras-chave:** Vanessa Battestin (abertura), Felipe Tessarolo (internacional),
