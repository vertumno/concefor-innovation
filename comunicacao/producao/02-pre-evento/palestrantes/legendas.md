...
>
> 📌 **Versão de WhatsApp (reescrita em 27/07): mesmo conteúdo do Instagram**, não um resumo.
> Ela era curta demais (3 linhas) e perdia o gancho e a credencial da pessoa, que é justamente
> o que faz alguém se inscrever. Agora acompanha o Instagram parágrafo a parágrafo, com quatro
> adaptações de canal:
> | Instagram | WhatsApp | Por quê |
> |---|---|---|
> | Sem título | Abre com `*VIII Concefor · [tipo de fala]*` | Em grupo, a mensagem precisa se identificar na primeira linha |
> | `@handle` da pessoa | Só o nome | Arroba não vira link no WhatsApp, só polui |
> | Hashtags no fim | Nenhuma | Não existem no WhatsApp |
> | "no link da bio" | O link no próprio texto: `https://concefor.cefor.ifes.edu.br/inscricoes/` | Não existe bio; o link tem que levar direto ao lugar onde a pessoa age |
>
> Negrito do WhatsApp é `*asterisco*` (um só de cada lado). Usar com parcimônia: título, data
> e hora.
>
...
Jaqueline Sanz coordena o Atlas das Mulheres do Espírito Santo, um exemplo prático do tema da própria mesa. É também servidora do Incaper e atua na Secretaria Estadual das Mulheres (SESM).
