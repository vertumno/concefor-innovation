# Painel de produção — Cards individuais de palestrantes (Onda 1)
...
Cada palestrante tem, abaixo, uma **"Info breve para o card"** (é só isso que vai na arte) e
uma **"Manchete/gancho para abrir a legenda"** (isso NÃO vai no card — é a primeira frase da
legenda, que já está escrita em [legendas.md](legendas.md); aqui fica só como referência do
raciocínio). O gancho sempre liga ao que a pessoa vai **efetivamente falar/discutir** no
Concefor — nunca uma curiosidade solta sobre ela.
...
- **No card — info breve do palestrante:** Dra. Vanessa Battestin · Professora titular do
  Ifes/Cefor, Coordenadora da UAB
...
- **No card — nome da palestra:** ⚠️ o título documentado em `contexto/03-palestrantes.md` é
  igual ao **tema geral do evento** ("Tecnologia, Transformação e Educação a Distância: 20 anos
...
- Tecnologia Delas: três pesquisadoras, um só tema — mulheres transformando a tecnologia na educação.
