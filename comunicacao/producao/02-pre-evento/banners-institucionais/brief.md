...
> que faltam** (MOOCs e Base de Conhecimentos) — sem eles não dá para gerar os QR codes.
> ⚠️ Não confundir com os **10 banners de sinalização do TR** ([brief](../../01-brindes-promocionais/banners/brief.md)):
> aqueles são do contrato da gráfica; estes três são custeados pela UAB.
...
## Objetivo
- Divulgar três produtos institucionais do Cefor durante o Concefor, com sobrevida como
...
## Referências
- Pedido original: [`_refs/2026-07-14-email-vanessa-arte-banners.md`](_refs/2026-07-14-email-vanessa-arte-banners.md)
- Identidade: [`contexto/05-identidade-visual.md`](../../../contexto/05-identidade-visual.md)

## Produção
- Ferramenta: Canva / outro
- **Link Canva:**
- Arquivo final:

## Publicação
- Canal(is): impressão em gráfica (Vanessa encaminha na volta das férias, início de agosto)
- Data prevista: exposição a partir de 17/08 (abertura do Concefor)
...
- [ ] Dimensões confirmadas com a gráfica
- [ ] Registrado no board
