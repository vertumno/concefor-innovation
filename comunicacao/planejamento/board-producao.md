...
| **Cards dos eventos paralelos — 6 cards individuais** 🆕 **pedido recebido em 03/08**: *"cards dos eventos paralelos para seus coordenadores divulgarem entre os seus"*. É a liberação que faltava desde 16/07. ⚠️ **Muda o formato**: eram 1 carrossel, agora são **6 cards, um por evento**, entregues a cada coordenação com texto pronto. ✅ **Conteúdo e textos de WhatsApp dos 6 já escritos** em [brief-cards.md](../producao/02-pre-evento/eventos-paralelos/brief-cards.md). 🔴 **Falta definir quem produz as artes.** | 🔴 **a definir** | quanto antes *(o evento é 20/08)* | ⬜ |
...
| Transmissão ao vivo — ✅ **todas as palestras e mesas-redondas** (decidido 16/07); reserva com o Thiago | Tiago / Leonardo | ⬜ |
| Interpretação Libras — ✅ em **todas as palestras e mesas-redondas**; Dulce buscando mais intérpretes | Carol / Eliana | ⬜ |

## Ideias
| Iniciativa | Responsável | Status |
|---|---|---|
| Podcasts história do Cefor | ___ | ⏸️ ideia |
| App do Concefor (demo aprovada pela Márcia 16/07 · validação 30/07 · lançamento 07/08) | Marquito / Elton | 🟡 |
